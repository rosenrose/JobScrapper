...
def report():
    if query := request.args.get("query"):
        ...
        if query in cache:
            ...
            jobs = {
                ...
                "Weworkremotely": [i for i in get_weworkremotely_jobs(query) if len(i.keys())],
    ...
    return render_template("report.html", resultsNumber=resultsNumber, searchBy=query, jobs=jobs)
